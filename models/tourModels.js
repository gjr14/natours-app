...
const tourSchema = new mongoose.Schema(
    {
        name: {
            ...
            minlength: [
                10,
                "A tour name must have mroe or equal than 10 characters",
            ],
            // Validator from validator.js library
            // validate: [validator.isAlpha, 'A tour name must only contain letters']
        },
        slug: String,
        duration: {
            type: Number,
            required: [true, "A tour must be a number"],
        },
        maxGroupSize: {
            type: Number,
        ...
        ratingsAverage: {
            type: Number,
            default: 0,
            min: [1, "A ratign mus be at least 1"],
        ...
        priceDiscount: {
            ...
            validate: {
                ...
                message:
                    "The price discount must be less than the original price",
            },
        },
        summary: {
            type: String,
